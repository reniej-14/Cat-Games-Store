            ...
            <div className="flex items-center justify-between max-w-[95%] md:max-w-6xl mx-auto p-2">
                ...
                <form className="flex gap-2 ">
                    ...
                    <button 
                        ...
                        onClick={onClick}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 md:size-7 hover:cursor-pointer">
                ...
                <div className="flex gap-4 md:gap-20 font-medium">
                    ...
                    <a href="#" className="transition-transform duration-300 hover:scale-125">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-7 md:size-8">
